  ...
  return (
    <MainLayout>
      ...
      <div className="md:grid container mx-auto w-full m-8 relative">
        ...
        <div className="bg-[#0B0706] w-full h-full absolute top-0.5 left-0.5 rounded-lg p-4 opacity-70">
          <div className="md:mt-24">
            <p className="text-3xl text-white text-center font-bold font-Roboto bold-italic">You can contribute to make <br /> the environment greener!</p>
            <div className="w-full gap-9 text-center mt-8" >
              <button className="bg-[#70C174] text-white btn p-3 rounded mr-8">
                Join as a volunteer
              </button>
